...
#         torch.save(edge_index, "edge_index_ori_cora_40.pt")
        print(edge_index)
...
#        torch.save(index, "index_ori_cora_40.pt")
#        torch.save(ptr, "ptr_ori_cora_40.pt")
#        torch.save(edge_index, "edge_index_ori_cora_40.pt")
#        i = torch.stack((index, ptr), dim=1)
#        attmat = torch.sparse_coo_tensor(i, alpha, [2708, 2708])
#        attmat = attmat.to_dense()
#        torch.save(alpha, "alpha0_ori_cora_40.pt")
        print(alpha, "alpha before softmax")
        alpha = softmax(alpha, index, ptr, size_i)
        print(alpha, "alpha after softmax")       
#        torch.save(alpha, "alpha1_ori_cora_40.pt")
